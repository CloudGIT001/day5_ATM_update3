...
本程序分为三部分 1：管理员平台；2：ATM信用卡中心；3：购物商城
...
└─ATM_作业练习--修改3
    ...
    │          auth.cpython-35.pyc
    │          auth.cpython-36.pyc
    │          auth_shop.cpython-35.pyc
    │          auth_shop.cpython-36.pyc
...
```
管理员用户：admin/abc123  功能：1：创建用户信息，2：修改用户信息 ...

普通用户： 普通用户可以由 购物商场注册生成，也可以由 管理员创建分配。都可以直接登录 购物商场 和 ATM信用卡中心。购物商城注册的用户默认：'balance': 0, 'credit': 30000 ； 管理员创建分配的用户：'balance': 20000, 'credit': 30000
```
